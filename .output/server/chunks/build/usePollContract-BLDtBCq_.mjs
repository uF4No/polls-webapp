...
import { c as config } from './server.mjs';
...
async function usePollContract() {
  const publicClient = createPublicClient({
    chain: zksyncSepoliaTestnet,
    transport: http("https://sepolia.era.zksync.dev")
  });
  const createPoll = async ({ title, optionOne, optionTwo, durationInMinutes }) => {
    try {
...
export { usePollContract as u };
//# sourceMappingURL=usePollContract-BLDtBCq_.mjs.map
